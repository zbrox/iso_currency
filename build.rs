...
fn write_enum_impl(file: &mut BufWriter<File>, data: &Vec<IsoData>) {
    ...
    for currency in data.iter() {
        writeln!(file, "            Currency::{} => {},", &currency.alpha3, currency.numeric).unwrap();
    }
    writeln!(file, "        }}").unwrap();
    writeln!(file, "    }}").unwrap();
    writeln!(file, "").unwrap();
    ...
    writeln!(file, "        match self {{").unwrap();
    for currency in data.iter() {
        writeln!(file, "            Currency::{} => \"{}\",", &currency.alpha3, &currency.name).unwrap();
    }
    writeln!(file, "        }}").unwrap();
    writeln!(file, "    }}").unwrap();
    writeln!(file, "").unwrap();
    ...
    writeln!(file, "        match self {{").unwrap();
    for currency in data.iter() {
        writeln!(file, "            Currency::{} => \"{}\",", &currency.alpha3, &currency.alpha3).unwrap();
    }
    writeln!(file, "        }}").unwrap();
    writeln!(file, "    }}").unwrap();
    writeln!(file, "").unwrap();
    ...
    for currency in data.iter() {
        ...
        writeln!(file, "            Currency::{} => vec![{}],", &currency.alpha3, &country_list).unwrap();
    }
    writeln!(file, "        }};").unwrap();
    ...
    for currency in data.iter() {
        writeln!(file, "            \"{}\" => Some(Currency::{}),", &currency.alpha3, &currency.alpha3).unwrap();
    }
    ...
    for currency in data.iter() {
        writeln!(file, "            {} => Some(Currency::{}),", currency.numeric, &currency.alpha3).unwrap();
    }
    writeln!(file, "            _ => None,").unwrap();
    writeln!(file, "        }}").unwrap();
    writeln!(file, "    }}").unwrap();
