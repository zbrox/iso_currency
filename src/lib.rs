...
impl Currency {
    ...
    pub fn used_by(&self) -> Vec<Country> {
        let mut territories = match self {
            Currency::AED => vec![Country::AE],
            Currency::AFN => vec![Country::AF],
            Currency::ALL => vec![Country::AL],
            Currency::AMD => vec![Country::AM],
            Currency::ANG => vec![Country::CW, Country::SX],
            Currency::AOA => vec![Country::AO],
            Currency::ARS => vec![Country::AR],
            Currency::AUD => vec![
                Country::AU,
                Country::CX,
                Country::CC,
            ...
            Currency::AWG => vec![Country::AW],
            Currency::AZN => vec![Country::AZ],
            Currency::BAM => vec![Country::BA],
            Currency::BBD => vec![Country::BB],
            Currency::BDT => vec![Country::BD],
            Currency::BGN => vec![Country::BG],
            Currency::BHD => vec![Country::BH],
            Currency::BIF => vec![Country::BI],
            Currency::BMD => vec![Country::BM],
            Currency::BND => vec![Country::BN],
            Currency::BOB => vec![Country::BO],
            Currency::BOV => vec![Country::BO],
            Currency::BRL => vec![Country::BR],
            Currency::BSD => vec![Country::BS],
            Currency::BTN => vec![Country::BT],
            Currency::BWP => vec![Country::BW],
            Currency::BYN => vec![Country::BY],
            Currency::BZD => vec![Country::BZ],
            Currency::CAD => vec![Country::CA],
            Currency::CDF => vec![Country::CD],
            Currency::CHE => vec![Country::CH],
            Currency::CHF => vec![Country::CH, Country::LI],
            Currency::CHW => vec![Country::CH],
            Currency::CLF => vec![Country::CL],
            Currency::CLP => vec![Country::CL],
            Currency::CNY => vec![Country::CN],
            Currency::COP => vec![Country::CO],
            Currency::COU => vec![Country::CO],
            Currency::CRC => vec![Country::CR],
            Currency::CUC => vec![Country::CU],
            Currency::CUP => vec![Country::CU],
            Currency::CVE => vec![Country::CV],
            Currency::CZK => vec![Country::CZ],
            Currency::DJF => vec![Country::DJ],
            Currency::DKK => vec![Country::DK, Country::FO, Country::GL],
            Currency::DOP => vec![Country::DO],
            Currency::DZD => vec![Country::DZ],
            Currency::EGP => vec![Country::EG],
            Currency::ERN => vec![Country::ER],
            Currency::ETB => vec![Country::ET],
            Currency::EUR => vec![
                Country::AX,
                Country::AD,
                Country::AT,
            ...
            Currency::FJD => vec![Country::FJ],
            Currency::FKP => vec![Country::FK],
            Currency::GBP => vec![
                Country::GB,
                Country::IO,
                Country::IM,
            ...
            Currency::GEL => vec![Country::GE],
            Currency::GHS => vec![Country::GH],
            Currency::GIP => vec![Country::GI],
            Currency::GMD => vec![Country::GM],
            Currency::GNF => vec![Country::GN],
            Currency::GTQ => vec![Country::GT],
            Currency::GYD => vec![Country::GY],
            Currency::HKD => vec![Country::HK],
            Currency::HNL => vec![Country::HN],
            Currency::HRK => vec![Country::HR],
            Currency::HTG => vec![Country::HT],
            Currency::HUF => vec![Country::HU],
            Currency::IDR => vec![Country::ID],
            Currency::ILS => vec![Country::IL, Country::PS],
            Currency::INR => vec![Country::IN, Country::BT],
            Currency::IQD => vec![Country::IQ],
            Currency::IRR => vec![Country::IR],
            Currency::ISK => vec![Country::IS],
            Currency::JMD => vec![Country::JM],
            Currency::JOD => vec![Country::JO],
            Currency::JPY => vec![Country::JP],
            Currency::KES => vec![Country::KE],
            Currency::KGS => vec![Country::KG],
            Currency::KHR => vec![Country::KH],
            Currency::KMF => vec![Country::KM],
            Currency::KPW => vec![Country::KP],
            Currency::KRW => vec![Country::KR],
            Currency::KWD => vec![Country::KW],
            Currency::KYD => vec![Country::KY],
            Currency::KZT => vec![Country::KZ],
            Currency::LAK => vec![Country::LA],
            Currency::LBP => vec![Country::LB],
            Currency::LKR => vec![Country::LK],
            Currency::LRD => vec![Country::LR],
            Currency::LSL => vec![Country::LS],
            Currency::LYD => vec![Country::LY],
            Currency::MAD => vec![Country::MA, Country::EH],
            Currency::MDL => vec![Country::MD],
            Currency::MGA => vec![Country::MG],
            Currency::MKD => vec![Country::MK],
            Currency::MMK => vec![Country::MM],
            Currency::MNT => vec![Country::MN],
            Currency::MOP => vec![Country::MO],
            Currency::MRU => vec![Country::MR],
            Currency::MUR => vec![Country::MU],
            Currency::MVR => vec![Country::MV],
            Currency::MWK => vec![Country::MW],
            Currency::MXN => vec![Country::MX],
            Currency::MXV => vec![Country::MX],
            Currency::MYR => vec![Country::MY],
            Currency::MZN => vec![Country::MZ],
            Currency::NAD => vec![Country::NA],
            Currency::NGN => vec![Country::NG],
            Currency::NIO => vec![Country::NI],
            Currency::NOK => vec![Country::NO, Country::SJ, Country::BV],
            Currency::NPR => vec![Country::NP],
            Currency::NZD => vec![
                Country::NZ,
                Country::CK,
                Country::NU,
            ...
            Currency::OMR => vec![Country::OM],
            Currency::PAB => vec![Country::PA],
            Currency::PEN => vec![Country::PE],
            Currency::PGK => vec![Country::PG],
            Currency::PHP => vec![Country::PH],
            Currency::PKR => vec![Country::PK],
            Currency::PLN => vec![Country::PL],
            Currency::PYG => vec![Country::PY],
            Currency::QAR => vec![Country::QA],
            Currency::RON => vec![Country::RO],
            Currency::RSD => vec![Country::RS],
            Currency::RUB => vec![Country::RU],
            Currency::RWF => vec![Country::RW],
            Currency::SAR => vec![Country::SA],
            Currency::SBD => vec![Country::SB],
            Currency::SCR => vec![Country::SC],
            Currency::SDG => vec![Country::SD],
            Currency::SEK => vec![Country::SE],
            Currency::SGD => vec![Country::SG],
            Currency::SHP => vec![Country::SH],
            Currency::SLL => vec![Country::SL],
            Currency::SOS => vec![Country::SO],
            Currency::SRD => vec![Country::SR],
            Currency::SSP => vec![Country::SS],
            ...
            Currency::TND => vec![Country::TN],
            Currency::TOP => vec![Country::TO],
            Currency::TRY => vec![Country::TR],
            Currency::TTD => vec![Country::TT],
            Currency::TWD => vec![Country::TW],
            Currency::TZS => vec![Country::TZ],
            Currency::UAH => vec![Country::UA],
            Currency::UGX => vec![Country::UG],
            Currency::USD => vec![
                Country::US,
                Country::AS,
                Country::BB,
            ...
            Currency::USN => vec![Country::US],
            Currency::UYI => vec![Country::UY],
            Currency::UYU => vec![Country::UY],
            Currency::UYW => vec![Country::UY],
            Currency::UZS => vec![Country::UZ],
            Currency::VES => vec![Country::VE],
            Currency::VND => vec![Country::VN],
            Currency::VUV => vec![Country::VU],
            Currency::WST => vec![Country::WS],
            Currency::XAF => vec![
                Country::CM,
                Country::CF,
                Country::CG,
            ...
            Currency::ZMW => vec![Country::ZM],
            Currency::ZWL => vec![Country::ZW],
        };
